...
part of 'jobs_api_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

JobsAPIModel _$JobsAPIModelFromJson(Map<String, dynamic> json) => JobsAPIModel(
...
Map<String, dynamic> _$JobsAPIModelToJson(JobsAPIModel instance) =>
    <String, dynamic>{
      '_id': instance.jobsId,
